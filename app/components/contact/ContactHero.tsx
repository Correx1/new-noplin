...
export default function ContactHero() {
  return (
    <section className="hero-section relative flex items-center justify-center w-full min-h-[40vh] lg:min-h-[45vh] pt-[50px] pb-10 lg:pt-[90px] lg:pb-12 overflow-hidden border-b border-(--grid-line-color) bg-gray-950 z-0">
 ...
 Contact Us
  <span className="absolute bottom-0 h-[2px] w-[50%] bg-amber-600 left-0 translate-x-0"></span>
        ...
        >
          Tell us what you need. <span className="text-amber-500s">We&apos;ll handle the rest.</span>
        </motion.h1>
